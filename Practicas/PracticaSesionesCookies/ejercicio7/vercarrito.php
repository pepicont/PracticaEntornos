...
<table width="720" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <form name="a<?php echo $v['identificador'] ?>" method="post" action="agregacar.php?<?php echo SID ?>" id="a<?php echo $v['identificador'] ?>">
    ...
    <td width="43" align="right"><?php echo "1" ?></td>
    <td width="136" align="center">
   <!--  <input name="cantidad" type="text" id="cantidad" value="<?php //echo $v['cantidad']?>" size="8"> -->
    <input name="id" type="hidden" id="id" value="<?php echo $v['id'] ?>"> </td>
    <td align="center"><a href="borrarcar.php?<?php echo SID ?>&id=<?php echo $v['id']?>"></a></td>
    <td align="center">
    </td>
    </tr>
</form>
...
<div align="center"><span class="prod">Continuar la selección de productos</span>
 <a href="catalogo.php?<?php echo SID;?>">Ver catálogo</a>&nbsp;
...
href="catalogo.php?<?php echo SID;?>"></a>
 <?php }?>
</p>
</body>
</html>